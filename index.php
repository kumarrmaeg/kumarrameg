...
<html lang="en" class="no-js">
	<head>
		...
		<title>Ram</title>
		<meta name="description" content="Ram - CV / Freelanceing by Ramkumar" />		
					...
					<header>
						<div class="header-wrap col-lg-10 center-div">
							...
							<div class="float-right social-download-wrap">
								<a href="<?php echo "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; ?>img/ram-resume.pdf" class="btn btn-default float-left">
									<span class="mask"></span>
									<span class="btn-label">
										<b>download resume</b>
					...
					<div id="main_content" class="content-block margin-top-150 margin-top-sm-70 margin-top-xs-50">
						...
						<div style="background:#ffcb15">
							<section id="intro_content_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div intro-content-wrap sec-pad">
								...
								<p class="pad-bottom-35 wow fadeInUp" data-wow-duration=".6s">
									Hi I am Ramkumar software engineering experience, with strong analytical and problem solving skills and a broad range of expertise in creating commercial applications and Web applications.My main objective is to provide excellent service,
								</p>
								<p class="wow fadeInUp" data-wow-duration=".4s">
									I guarantee my work and make sure my clients are 100% satisfied with my work.
								</p>
						...
						<div style="background:#f7f7f9">
							<section id="skill_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div skills-wrap  sec-pad-top sec-pad-bottom-xs">
								...
								<p class="wow fadeInUp" data-wow-duration=".4s">% is Based on my Hours of Working.</p>
								<div class="row margin-top-40">
									<div class="col-sm-5 margin-bottom-sm">
										<span class="progress-cat">Advanced MYSQL</span>
										<div class="progress-bar-graph"> 
											<div class="progress-bar-wrap">
												<div class="bar-wrap bar-wrap-first-row">
													<span data-width="97">
									...
									<div class="col-sm-5 margin-bottom-sm">
										...
										<div class="progress-bar-graph"> 
											<div class="progress-bar-wrap">
												<div class="bar-wrap bar-wrap-second-row">
													<span data-width="100">
									...
									<div class="col-sm-offset-1 col-sm-5 margin-bottom-sm">
										<span class="progress-cat">HTML , CSS ,Boostrap, PHP</span>
										<div class="progress-bar-graph"> 
											<div class="progress-bar-wrap">
												<div class="bar-wrap bar-wrap-second-row">
													<span data-width="100">
									...
									<div class="col-sm-5 margin-bottom-sm">
										...
										<div class="progress-bar-graph"> 
											<div class="progress-bar-wrap">
												<div class="bar-wrap bar-wrap-third-row">
													<span data-width="86">
									...
									<div class="col-sm-offset-1 col-sm-5 margin-bottom-sm">
										<span class="progress-cat">Adobe XD</span>
										<div class="progress-bar-graph"> 
											<div class="progress-bar-wrap">
												<div class="bar-wrap bar-wrap-third-row">
													<div class="bar-wrap">
														<span data-width="86">
															<strong><i>30</i>%</strong>
														</span>
													</div>	
												</div>
											</div>	
						...
						<div style="background:#fff">
							<section id="work_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div skills-wrap  sec-pad">
								...
								<div id="portfolio-wrap" class="padding-sec-lg">	
									...
									<p class="wow fadeInUp" data-wow-duration=".4s">				
										I'm Not Supposed To Share Some Of My Client Works.
									</p>
									<!-- Hidden video div -->
							...
							<section id="edu_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div education-wrap  sec-pad">
								...
								<div class="qualfication-wrap">
									<div class="qualfication wow fadeInUp" data-wow-duration=".4s">
										...
										<div class="col-sm-2">
											<span class="yr-pers vertical-align-pad">2015-2019</span>
										</div>
										<div class="col-sm-5">
											<span class="insti vertical-align-pad">K.L.N College of Engineering</span>
										</div>
										<div class="col-sm-3">
										...
										<div class="col-xs-10 exp-content-wrap">
											<div class="row">
												<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0s">
													<div class="col-sm-3 duration"><span>Mar 2019 - present</span></div>
													<div class="col-sm-9">
														<span class="job-desn">Freelancer</span>
														<span class="job-loc">Myself
		</span>
														<p class="job-summary p-small">In this period of time, I had the opportunity to turn my passion for the web & application in a job right before graduation.</p>
													</div>
												</div>	
											</div>
										</div>	
										...
										<div class="col-xs-10 exp-content-wrap">
											<div class="row">
												<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0.4s">
													<div class="col-sm-3 duration"><span>Jun 2019 – present</span></div>
													<div class="col-sm-9">
														<span class="job-desn">Software Engineer
		</span>
						...
						<div style="background:#fff">
							<section id="contact_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div contact-wrap  sec-pad-top sec-pad-bottom-sm">
								...
								<div class="email-direct">
									<p class="wow fadeInRight" data-wow-duration=".4s">Or simply email me at <a href="mailto:kumarrameg@yahoo.com">kumarrameg@yahoo.com</a></p>
								</div>
							</section>
						</div>	
						<!--Contact Sec-->
									...
									<div class="col-sm-6">
										<div class="social-icons-wrap float-right">
											...
											<ul class="social-icons float-right">
												<li>
													<a href="https://www.facebook.com/kumarrsmeg" class="social-icon" target="_blank"> 
												...
												<li>
													<a href="https://www.linkedin.com/in/ram-kumar-a8923313b/" target="_blank" class="social-icon">
														<span class="fa" data-hover="&#xf0e1;">&#xf0e1;</span>
													</a>
												</li>
												<li>
													<a href="https://www.instagram.com/kumarrameg/" class="social-icon" target="_blank">
														<span class="fa" data-hover="&#xf16d;">&#xf16d;</span>
													</a>
												</li>
											</ul>
